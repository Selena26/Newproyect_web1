                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">	
                                                ...
                                                <input type="text" placeholder="Nombre acopio" class="form-control" name="Nombre" value="<?php echo $Nombre; ?>">
                                            </div>
                                        </div>
                                    <div class="col">
                                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="email" placeholder="ejemplo@gmail.com" class="form-control" name="Contacto_email" value="<?php echo $Contacto_email; ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label>Número de teléfono</label>
                                                <input type="number" class="form-control"  placeholder="Número" name="Contacto_telefono" value="<?php echo $Contacto_telefono; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="latitud" class="form-control"  name="Latitud" value="<?php echo $Latitud; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col">
                                             <div class="form-group">
